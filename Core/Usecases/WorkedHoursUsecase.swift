...
class WorkedHoursUsecase {
    ...
    func total() {
        ...
        let pastWeekTotalHours = calculateHours(
            between: pastWeek.firstDate, and: pastWeek.lastDate)
        let pastWeekWorkWorkHours = WorkHourStruct(
            title: "Semana passada", total: pastWeekTotalHours)
        ...
        let currentMonthTotalHours = calculateHours(
            between: currentMonth.firstDate, and: currentMonth.lastDate)
        let currentMonthWorkHours = WorkHourStruct(
            title: "Mês atual", total: currentMonthTotalHours)
        ...
        let fromBeginningTotalHours = calculateHours(
            between: fromBeginning.firstDate, and: fromBeginning.lastDate)
        let fromBeginningWorkHours = WorkHourStruct(
            title: "Total", total: fromBeginningTotalHours)
